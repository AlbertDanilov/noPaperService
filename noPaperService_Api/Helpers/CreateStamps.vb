...
Namespace CreateStamps
    Public Class CreateStamps
        ...
        'Получение штампа
        Public Shared Function GetStamp(ByVal signComponent As Models.SignComponent, ByVal qrText As String, pvOtrDate As String, pvAptAcceptDate As String) As Image
            'Кисть
            ...
            Using g As Graphics = Graphics.FromImage(myBMP)
                ...
                g.DrawString(If(pvOtrDate, If(pvAptAcceptDate, signComponent.SignDateTimeUtc.ToLocalTime.ToString("yyyy.MM.dd HH:mm"))), New Font("Arial", 80), myBrush, New Rectangle(1000, myBMPHeight - 250, 2450, 150))
